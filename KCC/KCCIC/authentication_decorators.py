...
#file from old django project

# https://simpleisbetterthancomplex.com/tutorial/2018/01/18/how-to-implement-multiple-user-types-with-django.html
def student_required(function=None, redirect_field_name='redirect_from', redirect_url='KCCIC:login'):
    """
...
def advisor_required(function=None, redirect_field_name='redirect_from', redirect_url='KCCIC:login'):
    """
...
def account_type_required(function=None, redirect_field_name='redirect_from', redirect_url='KCCIC:login'):
    """
...
def unselected_account_type_required(function=None, redirect_field_name='redirect_from', redirect_url='KCCIC:login'):
    """
    Decorator for views that checks that the logged-in user has an account type,
    redirects to the log-in page if necessary.
    """
...
def admin_required(function=None, redirect_field_name='redirect_from', redirect_url='KCCIC:login'):
    actual_decorator = user_passes_test(
